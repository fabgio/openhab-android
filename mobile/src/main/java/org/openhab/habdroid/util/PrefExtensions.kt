...
fun SharedPreferences.getDefaultCarSitemapName(id: Int = getActiveServerId()): String? =
...
fun SharedPreferences.updateDefaultCarSitemap(sitemap: Sitemap?, id: Int = getActiveServerId()) {
    edit {
